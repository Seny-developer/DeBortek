...
import main_page
from registration import *  #Другие файлы .py(лежат в папке)
import DataBase
...
# GitHub: https://github.com/Seny-developer
# file: MVP 1.1
print("__Author__:", "Seny")
print("__Email__:", "ay.zhiliaev@outlook.com")                 # текст, который выводится в консоль
print("__WebSite__:",  "https://github.com/Seny-developer")
print("__Version__:", "MVP 1.1")
...
class Log_account(QWidget):         # Класс всего окна (можно без него, но с ним проще читать мне код)
    ...
    def after_press_register_in_log_in(self):                   
...
if __name__ == '__main__': # Запуск программы
    ...
    win_log_account.setStyleSheet("#MainWindow{background-color: #141414; max-width: 641; max-height: 480; min-width: 641; min-height: 480;}") # - цвет заднего фона
    ...
    sys.exit(app_log_account.exec_()) 
